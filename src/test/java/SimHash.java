...
public class SimHash {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String s1="餐饮服务；住宿服务；预包装食品销售；网络技术服务；电竞游戏服务。（依法须经批准的项目，经相关部门批准后方可开展经营活动）";
        String s2="餐饮管理；正餐服务；住宿服务；餐饮配送服务；酒店管理；会展服务；清洁服务；食品销售。（依法须经批准的项目，经相关部门批准后方可开展经营活动）";
        long start=System.currentTimeMillis();
        SimHash hash1 = new SimHash(s1, 64);
        SimHash hash2 = new SimHash(s2, 64);
        int distance = hash1.getDistance(hash1.strSimHash, hash2.strSimHash);
        System.out.println("用时:"+(System.currentTimeMillis()-start));
        System.out.println(distance);


//        String s = "生态农业项目的整体开发；农产品的种植与销售；观光农业的配套开发与经营；房地产开发经营；养老服务。";
...
//
//        // 删除首句话，并加入两个干扰串
//        s = "生态农业项目的整体开发；农产品的种植与销售；观光农业的配套开发与经营；";
//        SimHash hash2 = new SimHash(s, 64);
//        System.out.println(hash2.intSimHash + "  " + hash2.intSimHash.bitCount());
//        hash1.subByDistance(hash2, 3);
//
//        // 首句前添加一句话，并加入四个干扰串
//        s = "生态农业项目的整体开发；农产品的种植与销售；观光农业的配套开发与经营；房地产开发经营；养老服务。";
