...
public class GetLostExportFromMysql {
    ...
    public GetLostExportFromMysql(String startDateStr, String endDateStr) {
...
//        findReplyMsg("D:\\historyMessage\\msg\\msg-2019-04-14.zip");
        String startDateStr = "2019-04-25";
        String endDateStr = "2019-04-25";
...
//            String db[] = {"crdb_1","crdb_2"};
            ...
            for(String database : db) {
                for(String t : type) {
                    for(int i=0;i<=10;i++) {
                        if(  database.equals("crdb_1")){

                        } else if(t.equals("identify") && database.equals("crdb_2") ) {

                        } else if(t.equals("marketing") && database.equals("crdb_2") && i <=2)  {
