...
public class ExportFromOSS2 implements Runnable{
    ...
    public ExportFromOSS2(String startDateStr,String endDateStr) {
    ...
    public static void main(String args[]) {
        ...
        getLost("2019-02-25","2019-03-06","identify","crdb_2",8,Node3Host);
        getLost("2019-01-30","2019-03-06","marketing","crdb_2",8,Node3Host);
        getLost("2019-01-30","2019-03-06","identify","crdb_1",10,Node4Host);
