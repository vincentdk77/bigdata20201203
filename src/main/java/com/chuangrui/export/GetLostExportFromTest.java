...
public class GetLostExportFromTest {
    ...
    public GetLostExportFromTest(String startDateStr, String endDateStr) {
...
//
        ...
        String startDateStr = "2017-10-05";
        String endDateStr = "2017-10-05";
