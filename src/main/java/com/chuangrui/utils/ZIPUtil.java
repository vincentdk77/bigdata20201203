...
public class ZIPUtil {
    ...
    public static void main(String[] args) {
       ...
       // compress("D:\\historyMessage\\code\\common-code.txt","D:\\historyMessage\\code\\common-code.zip");
        readZipFile("D:\\historyMessage\\code\\common-code.zip");
    }

    public static void readZipFile(String readFilePath)  {
        try {
    ...
    public static void compress(String srcFilePath, String destFilePath) {
        ...
        try {
            ...
            zos.close();
            System.out.println(srcFilePath+" 已经压缩成 "+destFilePath);
        } catch (Exception e) {
