...
public class Cosine {
        ...
        public static void main(String[] args) {
            String str1="餐饮服务；住宿服务；预包装食品销售；网络技术服务；电竞游戏服务。（依法须经批准的项目，经相关部门批准后方可开展经营活动）";
            String str2="餐饮管理；正餐服务；住宿服务；餐饮配送服务；酒店管理；会展服务；清洁服务；食品销售。（依法须经批准的项目，经相关部门批准后方可开展经营活动）";

            String str3 = "制造业>农副食品加工业>饲料";
            String str4 = "批发和零售业>批发>农畜产品";
...
//            double Similarity2=Cosine.getSimilarity(str1, str3);
//            System.out.println(Similarity2);
//
//            double Similarity3=Cosine.getSimilarity(str1, str4);
